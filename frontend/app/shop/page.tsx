...
export const metadata = {
  title: "Shop"
  ,
  description: "Browse smart gadgets, workspace accessories, and home utility products with fast filtering and clear pricing.",
  alternates: {
    canonical: "/shop"
  }
};
  ...
  return (
    <section className="container-shell py-10">
      <div className="mb-8 space-y-3">
        ...
        <h1 className="section-title">Search, compare, and discover practical smart gadgets.</h1>
        <p className="section-copy">
          A mobile-first product grid with fast filtering, clear pricing, and trust-forward merchandising.
        </p>
      </div>
      <div className="mb-5 flex flex-wrap items-center gap-3 text-sm text-slate-600">
        ...
        <span className="rounded-full bg-orange-50 px-4 py-2 font-medium text-orange-700">Free shipping above Rs 999</span>
      </div>
      <form className="mb-8 grid gap-4 rounded-[2rem] border border-white/80 bg-white/90 p-5 shadow-sm md:grid-cols-4">
        <input
          name="q"
        ...
        />
        <select name="category" defaultValue={category} className="field-input rounded-full">
        ...
        <select name="sort" defaultValue={sort} className="field-input rounded-full">
